...
aliases:
  ...
  - bond yield
domain: bonds
units: nominal annual decimal rate compounded m_B times per year
...
Yield to maturity $y^{(m_B)}$ is the single nominal annual rate, compounded at
the stated \term{bond-payment-frequency}, that reproduces the toy
