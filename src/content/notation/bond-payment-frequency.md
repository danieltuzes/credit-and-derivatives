...
perspective: Positive integer in the simplified regular schedule.
sources:
...
The bond payment frequency $m_B$ is the number of scheduled coupon payments per
year in this simplified regular bond.
